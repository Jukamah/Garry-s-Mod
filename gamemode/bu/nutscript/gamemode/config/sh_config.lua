...
nut.config.add("logo", "https://mistforums.s3.amazonaws.com/upload/forum_34753/logo/dicky_1528688605.png", "The icon shown on the character menu. Max size is 86x86", nil, {
	category = "appearance"
})
nut.config.add("logoURL", "https://berserkgaming.mistforums.com/", "The URL opened when the icon is clicked.", nil, {
	category = "appearance"
})
...
nut.config.add("defMoney", 1000, "The amount of money that players start with.", nil, {
	category = "characters",
	data = {min = 0, max = 10000}
})
nut.config.add("allowVoice", true, "Whether or not voice chat is allowed.", nil, {
	category = "server"
})
...
nut.config.add("wepAlwaysRaised", true, "Whether or not weapons are always raised.", nil, {
	category = "server"
})
