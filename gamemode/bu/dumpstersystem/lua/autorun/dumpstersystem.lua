...
dumpsterSystem = dumpsterSystem or {
    config = {},

    IDENTIFIER = "dumpsterSystem",
    NICE_NAME = "Dumpster System"
}
...
frile.includeFolder( "dumpstersystem/", false, true )
frile.includeFolder( "dumpstersystem/libraries/" )
frile.includeFolder( "dumpstersystem/module/" )
