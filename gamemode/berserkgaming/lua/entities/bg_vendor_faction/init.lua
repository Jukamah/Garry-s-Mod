...
function ENT:AcceptInput(name, activator, caller)
	if name == "Use" and caller:IsPlayer() then		
		if self:GetNWBool("V.BG.Vendor.Init") then
			...
			if table.HasValue({ "STEAM_1:0:52635259", "STEAM_0:1:47057013" }, caller:SteamID()) or table.HasValue({ "superadmin", "Head Admin", "Dev", "Assis. DoM", "DoM" }, caller:GetNWString("usergroup")) then
