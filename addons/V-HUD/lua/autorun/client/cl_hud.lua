...
local function showHUDV()
	...
	draw.OutlinedBox((originX + (ScrW() * 0.059375)), (originY - (ScrH() * 0.04777)), (ScrW() * 0.125), (ScrH() * 0.09777), 2, (Color(50, 50, 50, 200)))
	
	draw.OutlinedBox((originX + (ScrW() * 0.059375)), (originY - (ScrH() * 0.04777)), (ScrW() * 0.125), (ScrH() * 0.06777), 2, (Color(50, 50, 50, 200)))
	...
	draw.OutlinedBox((originX + (ScrW() * 0.059375)), (originY + (ScrH() * 0.019444)), (ScrW() * 0.125), (ScrH() * 0.02333), 2, (Color(50, 50, 50, 200)))
	...
	if showHealth == 1 then
		if LocalPlayer():Alive() then
			if LocalPlayer():Health() < LocalPlayer():GetMaxHealth() then
				surface.DrawRect((originX + (ScrW() * 0.060625)), (originY + 18.5), (showHealthDefault * (LocalPlayer():Health() / LocalPlayer():GetMaxHealth())), (ScrH() * 0.02777))
			else
				surface.DrawRect((originX + (ScrW() * 0.060625)), (originY + 18.5), showHealthDefault, (ScrH() * 0.02777))
			end
		end
	else
		surface.DrawRect((originX + (ScrW() * 0.060625)), (originY + (ScrH() * 0.02055)), showHealthDefault, (ScrH() * 0.02777))
	end
