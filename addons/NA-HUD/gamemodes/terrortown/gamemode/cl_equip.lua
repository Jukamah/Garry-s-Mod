...
local function TraitorMenuPopup()
   ...
   dframe.Paint = function()
		draw.RoundedBox(8, 0, 0, dframe:GetWide(), dframe:GetTall(), Color(50, 50, 150))
   end
   ...
   dsheet.Paint = function()
	draw.RoundedBox(8, 0, 0, dsheet:GetWide(), dsheet:GetTall(), Color(150, 150, 255))
   end
   ...
   dsheet.Paint = function()
		draw.RoundedBox(8, 0, 0, dsheet:GetWide(), dsheet:GetTall(), Color(150, 150, 150))
   end
   ...
   dconfirm.DoClick = function()
	...
	dconfirm.Paint = function()
		draw.RoundedBox(8, 0, 0, dconfirm:GetWide(), dconfirm:GetTall(), Color(100, 100, 255))
	end
   ...
   dcancel.Paint = function()
		draw.RoundedBox(8, 0, 0, dcancel:GetWide(), dcancel:GetTall(), Color(200, 50, 50))
   end
